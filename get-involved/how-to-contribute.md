...
* [Criação ou atualização do sumário](how-to-contribute.md#criacao-ou-atualizacao-do-sumario)
...
* Use [links relativos↗](https://github.blog/2013-01-31-relative-links-in-markup-files/) para navegar entre os diferentes arquivos desta base de conhecimento.
  * `[Other file link](other_file.md)` → [Link de outro arquivo](how-to-contribute.md)
* Use links âncora para títulos dentro do mesmo arquivo.
  * `[Anchor link](#heading-anchor)` → [Link âncora](how-to-contribute.md#notas-sobre-a-padronizacao-da-documentacao)
* Combine links relativos a outros arquivos com links âncora.
  * `[Other file anchor link](other_file.md#heading-anchor)` → [Link de outro arquivo](how-to-contribute.md#notas-sobre-a-padronizacao-da-documentacao)
